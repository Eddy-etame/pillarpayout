  ...
  async calculatePlayerStats(userId) {
    try {
      ...
      const stats = {
        userId,
        totalBets,
        totalWagered: parseFloat((totalWagered || 0).toFixed(2)),
        totalWon: parseFloat((totalWon || 0).toFixed(2)),
        totalLost: parseFloat((totalLost || 0).toFixed(2)),
        wins: wins || 0,
        losses: losses || 0,
        biggestWin: parseFloat((biggestWin || 0).toFixed(2)),
        biggestLoss: parseFloat((biggestLoss || 0).toFixed(2)),
        highestMultiplier: parseFloat((highestMultiplier || 0).toFixed(2)),
        averageBet: parseFloat((averageBet || 0).toFixed(2)),
        winRate: parseFloat((winRate || 0).toFixed(2)),
        profitLoss: parseFloat((profitLoss || 0).toFixed(2)),
        recentStats,
